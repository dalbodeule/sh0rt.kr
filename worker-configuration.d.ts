/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 72a3d7d1be87e1ef994703730a4ebf13)
...
interface __BaseEnv_Env {
	...
	NUXT_OAUTH_CHZZK_CLIENT_ID: "c084e949-d337-4735-af2b-42db0c68c18d";
	NUXT_OAUTH_TWITCH_CLIENT_ID: "j8eszmagvnvbrz92h5w0ix40d4eu8g";
	NUXT_PUBLIC_BASE_URL: "https://sh0rt.kr";
	NUXT_REPORT_DOMAINS: "sh0rt.kr";
	NUXT_OAUTH_GITHUB_CLIENT_SECRET: string;
	NUXT_OAUTH_GOOGLE_CLIENT_SECRET: string;
	NUXT_SESSION_PASSWORD: string;
	NUXT_ANALYTICS_ACCOUNT_ID: string;
	NUXT_ANALYTICS_API_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NUXT_OAUTH_GITHUB_CLIENT_ID" | "NUXT_OAUTH_GOOGLE_CLIENT_ID" | "NUXT_OAUTH_CHZZK_CLIENT_ID" | "NUXT_OAUTH_TWITCH_CLIENT_ID" | "NUXT_PUBLIC_BASE_URL" | "NUXT_REPORT_DOMAINS" | "NUXT_OAUTH_GITHUB_CLIENT_SECRET" | "NUXT_OAUTH_GOOGLE_CLIENT_SECRET" | "NUXT_SESSION_PASSWORD" | "NUXT_ANALYTICS_ACCOUNT_ID" | "NUXT_ANALYTICS_API_TOKEN" | "NUXT_TURNSTILE_SECRET_KEY" | "NUXT_PUBLIC_TURNSTILE_SITE_KEY">> {}
}
