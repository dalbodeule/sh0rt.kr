...
본 약관은 sh0rt.kr가 운영하는 온라인 쇼핑몰 'sh0rt.kr'에서 제공하는 서비스(이하 '서비스'라 합니다)를 이용함에 있어 당사자의 권리 의무 및 책임사항을 규정하는 것을 목적으로 합니다.
PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 본 약관을 준용합니다.

### 제2조(정의)

'회사'라 함은, 'sh0rt.kr'가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 운영하는 사업자를 말하며, 아울러
'sh0rt.kr'을 통해 제공되는 전자상거래 관련 서비스의 의미로도 사용합니다.
...
'회사'는 '회원' 회원가입 시 기재한 전자우편을 이용하여 '회원'에게 통지 할 수 있습니다.
...
'회사'는 별도의 약정이 없는 이상, '구매자'가 청약을 한 날부터 7일 이내에 재화 등을 배송할 수 있도록 주문제작, 포장 등 기타 필요한 조치를 취합니다.
다만 '회사'가 이미 대금의 전부 또는 일부를 받은 경우에는 대금을 받은 날부터 3 영업일 이내에 필요한 조치를 취합니다.
...
'회사'와 재화 등의 구매에 관한 계약을 체결한 '구매자'는 수신확인의 통지를 받은 날부터 7일이내에 청약을 철회할 수 있습니다.
...
'회원'은 부여된 계정을 직접 관리해야 합니다.
'회원'이 자신의 계정를 도난당하거나 제3자가 사용하고 있음을 인지한 경우에는 바로 '회사'에 통보하고 안내에 따라야 합니다.

### 제20조(저작권의 귀속 및 이용)

'회사'가 제공하는 서비스 및 이와 관련된 모든 지식재산권은 '회사'에 귀속됩니다
